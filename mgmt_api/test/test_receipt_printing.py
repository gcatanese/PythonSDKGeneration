...
from openapi_client.models.receipt_printing import ReceiptPrinting  # noqa: E501
from openapi_client.rest import ApiException

class TestReceiptPrinting(unittest.TestCase):
    """ReceiptPrinting unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ReceiptPrinting
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReceiptPrinting`
        """
        model = openapi_client.models.receipt_printing.ReceiptPrinting()  # noqa: E501
        if include_optional :
