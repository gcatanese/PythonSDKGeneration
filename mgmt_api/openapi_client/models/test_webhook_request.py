...
class TestWebhookRequest(BaseModel):
    ...
    __properties = ["notification", "types"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TestWebhookRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TestWebhookRequest:
        """Create an instance of TestWebhookRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return TestWebhookRequest.parse_obj(obj)

        _obj = TestWebhookRequest.parse_obj({
