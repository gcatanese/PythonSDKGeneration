...
class StoreCreationRequest(BaseModel):
    ...
    __properties = ["address", "businessLineIds", "description", "externalReferenceId", "phoneNumber", "reference", "shopperStatement", "splitConfiguration"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StoreCreationRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StoreCreationRequest:
        """Create an instance of StoreCreationRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return StoreCreationRequest.parse_obj(obj)

        _obj = StoreCreationRequest.parse_obj({
