...
class ListCompanyUsersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCompanyUsersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCompanyUsersResponse:
        """Create an instance of ListCompanyUsersResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListCompanyUsersResponse.parse_obj(obj)

        _obj = ListCompanyUsersResponse.parse_obj({
            "links": PaginationLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "data": [CompanyUser.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
