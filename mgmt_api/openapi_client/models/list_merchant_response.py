...
class ListMerchantResponse(BaseModel):
    ...
    data: Optional[List[Merchant]] = Field(None, description="The list of merchant accounts.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListMerchantResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListMerchantResponse:
        """Create an instance of ListMerchantResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListMerchantResponse.parse_obj(obj)

        _obj = ListMerchantResponse.parse_obj({
            "links": PaginationLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "data": [Merchant.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
