...
class CreateApiCredentialResponse(BaseModel):
    ...
    __properties = ["_links", "active", "allowedIpAddresses", "allowedOrigins", "apiKey", "clientKey", "description", "id", "password", "roles", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateApiCredentialResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateApiCredentialResponse:
        """Create an instance of CreateApiCredentialResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateApiCredentialResponse.parse_obj(obj)

        _obj = CreateApiCredentialResponse.parse_obj({
