...
class ListStoresResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListStoresResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListStoresResponse:
        """Create an instance of ListStoresResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListStoresResponse.parse_obj(obj)

        _obj = ListStoresResponse.parse_obj({
            "links": PaginationLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "data": [Store.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
