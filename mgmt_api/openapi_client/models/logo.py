...
class Logo(BaseModel):
    ...
    """
    data: Optional[constr(strict=True, max_length=350000)] = Field(None, description="The image file, converted to a Base64-encoded string, of the logo to be shown on the terminal.")
    __properties = ["data"]
