...
class UpdateMerchantApiCredentialRequest(BaseModel):
    ...
    __properties = ["active", "allowedOrigins", "description", "roles"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateMerchantApiCredentialRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateMerchantApiCredentialRequest:
        """Create an instance of UpdateMerchantApiCredentialRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UpdateMerchantApiCredentialRequest.parse_obj(obj)

        _obj = UpdateMerchantApiCredentialRequest.parse_obj({
