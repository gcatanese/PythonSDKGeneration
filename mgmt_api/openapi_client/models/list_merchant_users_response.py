...
class ListMerchantUsersResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListMerchantUsersResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListMerchantUsersResponse:
        """Create an instance of ListMerchantUsersResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListMerchantUsersResponse.parse_obj(obj)

        _obj = ListMerchantUsersResponse.parse_obj({
