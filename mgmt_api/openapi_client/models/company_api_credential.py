...
class CompanyApiCredential(BaseModel):
    ...
    __properties = ["_links", "active", "allowedIpAddresses", "allowedOrigins", "associatedMerchantAccounts", "clientKey", "description", "id", "roles", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompanyApiCredential:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompanyApiCredential:
        """Create an instance of CompanyApiCredential from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CompanyApiCredential.parse_obj(obj)

        _obj = CompanyApiCredential.parse_obj({
