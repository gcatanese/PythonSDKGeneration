...
class ListMerchantApiCredentialsResponse(BaseModel):
    ...
    data: Optional[List[ApiCredential]] = Field(None, description="The list of API credentials.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListMerchantApiCredentialsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListMerchantApiCredentialsResponse:
        """Create an instance of ListMerchantApiCredentialsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListMerchantApiCredentialsResponse.parse_obj(obj)

        _obj = ListMerchantApiCredentialsResponse.parse_obj({
            "links": PaginationLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "data": [ApiCredential.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
