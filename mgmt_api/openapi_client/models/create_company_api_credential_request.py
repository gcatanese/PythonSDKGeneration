...
class CreateCompanyApiCredentialRequest(BaseModel):
    ...
    """
    allowed_origins: Optional[List[StrictStr]] = Field(None, alias="allowedOrigins", description="List of [allowed origins](https://docs.adyen.com/development-resources/client-side-authentication#allowed-origins) for the new API credential.")
    ...
    __properties = ["allowedOrigins", "associatedMerchantAccounts", "description", "roles"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCompanyApiCredentialRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCompanyApiCredentialRequest:
        """Create an instance of CreateCompanyApiCredentialRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateCompanyApiCredentialRequest.parse_obj(obj)

        _obj = CreateCompanyApiCredentialRequest.parse_obj({
