...
class UpdateCompanyUserRequest(BaseModel):
    ...
    associated_merchant_accounts: Optional[List[StrictStr]] = Field(None, alias="associatedMerchantAccounts", description="The list of [merchant accounts](https://docs.adyen.com/account/account-structure#merchant-accounts) to associate the user with.")
    ...
    __properties = ["accountGroups", "active", "associatedMerchantAccounts", "email", "name", "roles", "timeZoneCode"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateCompanyUserRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateCompanyUserRequest:
        """Create an instance of UpdateCompanyUserRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return UpdateCompanyUserRequest.parse_obj(obj)

        _obj = UpdateCompanyUserRequest.parse_obj({
