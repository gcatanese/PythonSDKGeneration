...
class AdditionalSettings(BaseModel):
    ...
    __properties = ["includeEventCodes", "properties"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdditionalSettings:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdditionalSettings:
        """Create an instance of AdditionalSettings from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AdditionalSettings.parse_obj(obj)

        _obj = AdditionalSettings.parse_obj({
