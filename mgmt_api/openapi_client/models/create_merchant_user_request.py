...
class CreateMerchantUserRequest(BaseModel):
    ...
    __properties = ["accountGroups", "email", "name", "roles", "timeZoneCode", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMerchantUserRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMerchantUserRequest:
        """Create an instance of CreateMerchantUserRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateMerchantUserRequest.parse_obj(obj)

        _obj = CreateMerchantUserRequest.parse_obj({
