...
class ApiCredential(BaseModel):
    ...
    __properties = ["_links", "active", "allowedIpAddresses", "allowedOrigins", "clientKey", "description", "id", "roles", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiCredential:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiCredential:
        """Create an instance of ApiCredential from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ApiCredential.parse_obj(obj)

        _obj = ApiCredential.parse_obj({
