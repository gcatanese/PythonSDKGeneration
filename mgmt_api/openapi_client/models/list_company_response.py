...
class ListCompanyResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListCompanyResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListCompanyResponse:
        """Create an instance of ListCompanyResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListCompanyResponse.parse_obj(obj)

        _obj = ListCompanyResponse.parse_obj({
            "links": PaginationLinks.from_dict(obj.get("_links")) if obj.get("_links") is not None else None,
            "data": [Company.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
