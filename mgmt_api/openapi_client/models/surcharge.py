...
class Surcharge(BaseModel):
    ...
    """
    ask_confirmation: Optional[StrictBool] = Field(None, alias="askConfirmation", description="Show the surcharge details on the terminal, so the shopper can confirm.")
    configurations: Optional[List[Configuration]] = Field(None, description="Surcharge fees or percentages for specific payment methods, funding sources (credit or debit), and currencies.")
    __properties = ["askConfirmation", "configurations"]
    ...
    def from_dict(cls, obj: dict) -> Surcharge:
        ...
        _obj = Surcharge.parse_obj({
            "ask_confirmation": obj.get("askConfirmation"),
