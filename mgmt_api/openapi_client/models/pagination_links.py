...
class PaginationLinks(BaseModel):
    ...
    first: LinksElement = ...
    last: LinksElement = ...
    next: Optional[LinksElement] = None
    prev: Optional[LinksElement] = None
    var_self: LinksElement = Field(..., alias="self")
    __properties = ["first", "last", "next", "prev", "self"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginationLinks:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginationLinks:
        """Create an instance of PaginationLinks from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return PaginationLinks.parse_obj(obj)

        _obj = PaginationLinks.parse_obj({
            "first": LinksElement.from_dict(obj.get("first")) if obj.get("first") is not None else None,
            "last": LinksElement.from_dict(obj.get("last")) if obj.get("last") is not None else None,
            "next": LinksElement.from_dict(obj.get("next")) if obj.get("next") is not None else None,
            "prev": LinksElement.from_dict(obj.get("prev")) if obj.get("prev") is not None else None,
