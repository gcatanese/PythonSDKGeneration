...
class ListWebhooksResponse(BaseModel):
    ...
    account_reference: Optional[StrictStr] = Field(None, alias="accountReference", description="Reference to the account.")
    data: Optional[List[Webhook]] = Field(None, description="The list of webhooks configured for this account.")
    ...
    __properties = ["_links", "accountReference", "data", "itemsTotal", "pagesTotal"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ListWebhooksResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ListWebhooksResponse:
        """Create an instance of ListWebhooksResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ListWebhooksResponse.parse_obj(obj)

        _obj = ListWebhooksResponse.parse_obj({
