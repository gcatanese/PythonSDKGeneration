...
class CreateCompanyApiCredentialResponse(BaseModel):
    ...
    api_key: StrictStr = Field(..., alias="apiKey", description="The API key for the API credential that was created.")
    associated_merchant_accounts: List[StrictStr] = Field(..., alias="associatedMerchantAccounts", description="List of merchant accounts that the API credential has access to.")
    ...
    password: StrictStr = Field(..., description="The password for the API credential that was created.")
    ...
    __properties = ["_links", "active", "allowedIpAddresses", "allowedOrigins", "apiKey", "associatedMerchantAccounts", "clientKey", "description", "id", "password", "roles", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCompanyApiCredentialResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCompanyApiCredentialResponse:
        """Create an instance of CreateCompanyApiCredentialResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateCompanyApiCredentialResponse.parse_obj(obj)

        _obj = CreateCompanyApiCredentialResponse.parse_obj({
