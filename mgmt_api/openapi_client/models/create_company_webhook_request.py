...
class CreateCompanyWebhookRequest(BaseModel):
    ...
    filter_merchant_account_type: StrictStr = Field(..., alias="filterMerchantAccountType", description="Shows how merchant accounts are filtered when configuring the webhook. Possible values: * **includeAccounts**: The webhook is configured for the merchant accounts listed in `filterMerchantAccounts`. * **excludeAccounts**: The webhook is not configured for the merchant accounts listed in `filterMerchantAccounts`. * **allAccounts**: Includes all merchant accounts, and does not require specifying `filterMerchantAccounts`.")
    filter_merchant_accounts: List[StrictStr] = Field(..., alias="filterMerchantAccounts", description="A list of merchant account names that are included or excluded from receiving the webhook. Inclusion or exclusion is based on the value defined for `filterMerchantAccountType`.  Required if `filterMerchantAccountType` is either: * **includeAccounts** * **excludeAccounts**  Not needed for `filterMerchantAccountType`: **allAccounts**.")
    ...
    __properties = ["acceptsExpiredCertificate", "acceptsSelfSignedCertificate", "acceptsUntrustedRootCertificate", "active", "additionalSettings", "communicationFormat", "description", "filterMerchantAccountType", "filterMerchantAccounts", "networkType", "password", "populateSoapActionHeader", "sslVersion", "type", "url", "username"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCompanyWebhookRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCompanyWebhookRequest:
        """Create an instance of CreateCompanyWebhookRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateCompanyWebhookRequest.parse_obj(obj)

        _obj = CreateCompanyWebhookRequest.parse_obj({
