...
class CreateAllowedOriginRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateAllowedOriginRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateAllowedOriginRequest:
        """Create an instance of CreateAllowedOriginRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return CreateAllowedOriginRequest.parse_obj(obj)

        _obj = CreateAllowedOriginRequest.parse_obj({
